...
global m_auto   := new CEEntry("Auto - Money")
global m_souls  := new CEEntry("Money")

class Darksiders2Tainer extends CETrainer
{
	OnLoop()
	{		
		if (!m_auto.IsFrozen())
...
Darksiders2Tainer.__init().TrainerLoop("Darksiders2.exe", 100)
return

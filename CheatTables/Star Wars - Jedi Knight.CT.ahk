...
global battery      := new CEEntry("Battery")
global inf_battery  := new CEEntry("B - inf Baterries")
class JKTrainer extends CETrainer
{
	...
	{	
        ...
        this.Speak(inf_battery.Toogle("Infinite Baterries")) 
        ...
        if inf_battery.IsFrozen()
        {
            battery.SetValue(200)			
        }

	}
}
JKTrainer.TrainerLoop("JK.exe", 100)
return

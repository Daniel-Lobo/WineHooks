...
hit_code:
  ...
  //cmp [esi+384], 1
  //je player
  cmp [ebp-3CF540], dv.exe+16C6B8
  je player
  cmp [ebp-3CF57C], dv.exe+16C6B8
  je player  // hit by arrow
  cmp [ebp-3CF140], dv.exe+16C6B8
  je weapons // enter cheat option
  cmp [ebp-3CF554], dv.exe+16C6B8
  je enemy
  cmp [ebp-3CF518], dv.exe+16C6B8
  je enemy   // hit with melee weapon
  cmp [ebp-3CF488], dv.exe+16C6B8
  jmp use_weapon
jmp hit_retadd
...
kill_flag:
  db 00 00 00 00
        ...
        <CheatEntry>
          <ID>5</ID>
          <Description>"M - inf Mana"</Description>
          <VariableType>Auto Assembler Script</VariableType>
          <AssemblerScript>[enable]
weapon_flag:
  db 00 00 00 01

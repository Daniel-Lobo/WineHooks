...
InitGLHooks()
{
	...
	if (g_.cfg.RLMT)
	{
		d := strsplit(["640x480", "800x600", "1024x768", "960x540", "1280x720", "1366x768", "1600x900", "1920x1080", "2560x1440", "3840x2160"
		,"480x270" ,"640x360"][g_.cfg.RLMT], "x" )	
		GL_HOOKS.W    := d[1]
		GL_HOOKS.H    := d[2]
	}	
...
GLSwap()
{	
	dllcall(gl.p.wglSwapIntervalEXT, uint, 1)
	if (g_tswap.e)
	{
...
wglMakeCurrent(hDC, Ctxt)
{
	...
	. " glDrawBufferRegion glReadBufferRegion glGetCompressedTextureImage glGetCompressedTexImage glCheckFramebufferStatus wglSwapIntervalEXT", " ")
	{

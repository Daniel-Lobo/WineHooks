...
Global D3D11_INPUT_PER_VERTEX_DATA := 0
...
Global  := 
Global D3D11_DSV_DIMENSION_UNKNOWN := 0
...
Global D3D11_RTV_DIMENSION_UNKNOWN := 0
...
Global D3D11_UAV_DIMENSION_UNKNOWN := 0
...
Global D3D11_USAGE_DEFAULT := 0
Global D3D11_USAGE_IMMUTABLE := 1
Global D3D11_USAGE_DYNAMIC := 2
Global D3D11_USAGE_STAGING := 3
Global D3D11_BIND_VERTEX_BUFFER := 0x1L
Global D3D11_BIND_INDEX_BUFFER := 0x2L
Global D3D11_BIND_CONSTANT_BUFFER := 0x4L
Global D3D11_BIND_SHADER_RESOURCE := 0x8L
Global D3D11_BIND_STREAM_OUTPUT := 0x10L
Global D3D11_BIND_RENDER_TARGET := 0x20L
Global D3D11_BIND_DEPTH_STENCIL := 0x40L
Global D3D11_BIND_UNORDERED_ACCESS := 0x80L
Global D3D11_CPU_ACCESS_WRITE := 0x10000L
Global D3D11_CPU_ACCESS_READ := 0x20000L
Global D3D11_RESOURCE_MISC_GENERATE_MIPS := 0x1L
Global D3D11_RESOURCE_MISC_SHARED := 0x2L
Global D3D11_RESOURCE_MISC_TEXTURECUBE := 0x4L
Global D3D11_RESOURCE_MISC_DRAWINDIRECT_ARGS := 0x10L
Global D3D11_RESOURCE_MISC_BUFFER_ALLOW_RAW_VIEWS := 0x20L
Global D3D11_RESOURCE_MISC_BUFFER_STRUCTURED := 0x40L
Global D3D11_RESOURCE_MISC_RESOURCE_CLAMP := 0x80L
Global D3D11_RESOURCE_MISC_SHARED_KEYEDMUTEX := 0x100L
Global D3D11_RESOURCE_MISC_GDI_COMPATIBLE := 0x200L
...
Global D3D11_MAP_FLAG_DO_NOT_WAIT := 0x100000L
Global D3D11_RAISE_FLAG_DRIVER_INTERNAL_ERROR := 0x1L
Global D3D11_CLEAR_DEPTH := 0x1L
Global D3D11_CLEAR_STENCIL := 0x2L
...
Global D3D11_DEPTH_WRITE_MASK_ZERO := 0
...
Global D3D11_TEXTURECUBE_FACE_POSITIVE_X := 0
...
Global D3D11_DSV_READ_ONLY_DEPTH := 0x1L
Global D3D11_DSV_READ_ONLY_STENCIL := 0x2L
Global D3D11_BUFFER_UAV_FLAG_RAW := 0x1
Global D3D11_BUFFER_UAV_FLAG_APPEND := 0x2
Global D3D11_BUFFER_UAV_FLAG_COUNTER := 0x4
Global D3D11_FILTER_MIN_MAG_MIP_POINT := 0
...
Global D3D11_FILTER_TYPE_POINT := 0

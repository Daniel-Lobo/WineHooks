...
/*
ddraw := new ddraw_h_parser(C:\DX8SDK\include\ddraw.h")
ddraw.save("ddraw.h.ahk")

d3d := new d3d_h_parser("C:\DX8SDK\include\d3d.h")
d3d.save("d3d.h.ahk")

d3dtypes := new d3dtypes_h_parser("C:\DX8SDK\include\d3dtypes.h")
d3dtypes.save("d3dtypes.h.ahk")

d3sound := new d3sound_h_parser("C:\DX8SDK\include\dsound.h")
d3sound.save("dsound.h.ahk")

d3D8 := new d3D9_h_parsers("C:\DX8SDK\include\d3D8.h")
d3D8.save("d3d8.h.ahk")

d3d8types := new d3D9_h_parsers("C:\DX8SDK\include\d3D8types.h")
d3d8types.save("d3d8types.h.ahk")

d3d9 := new d3D9_h_parsers("C:\Program Files (x86)\Microsoft DirectX SDK (June 2010)\Include\d3D9.h")
d3d9.save("d3d9.h.ahk")

d3d9types := new d3D9_h_parsers("C:\Program Files (x86)\Microsoft DirectX SDK (June 2010)\Include\d3D9types.h")
d3d9types.enums.remove(106)
d3d9types.save("d3d9types.h.ahk")

d3DX9core := new CppWrapper("C:\Program Files (x86)\Microsoft DirectX SDK (June 2010)\Include\d3DX9core.h")
d3DX9core.save("d3dX9core.h.ahk")

dinput := new dinput_h_parser("C:\DX8SDK\include\dinput.h")
dinput.save("dinput.h.ahk")

gl := new CppWrapper("C:\Program Files (x86)\Microsoft SDKs\Windows\v7.1A\Include\gl\GL.h")
gl.save("gl.h.ahk")

glcoreARB := new CppWrapper(A_mydocuments "\QtCreator\peixoto\OpenGL\glcorearb.h")
glcoreARB.save("glcoreARB.h.ahk")

glEXT := new CppWrapper(A_mydocuments "\QtCreator\peixoto\OpenGL\glext.h")
glEXT.save("glEXT.h.ahk")

wglEXT := new CppWrapper(A_mydocuments "\QtCreator\peixoto\OpenGL\wglEXT.h")
wglEXT.save("wglEXT.h.ahk")
*/
